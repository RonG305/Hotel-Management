...
const Sidebar = () => {
    ...
    return (
        ...
        <div className="  h-[100vh] bg-purple-700  px-5 fixed z-50 ">
          ...
          <div className="text-white ">
              <ul className="flex flex-col gap-5 font-bold ">
                  ...
                  <Link to='customers/'> <li className={sidebarLinkStyles}><FiUser size={25} /> <span className={`${sidebar ? 'flex' : 'hidden'}`}>Customers</span></li></Link>
